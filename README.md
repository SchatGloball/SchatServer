...
protoc --dart_out=grpc:lib/generated -Iproto proto/social.proto     //для модели сообществ

миграция базы данных:
dart run build_runner build

dart run stormberry migrate --db=schat --host=localhost --port=5432 --username=postgres --password=postgres --[no-]ssl
dart run stormberry migrate --db=schat --host=localhost --port=5432 --username=postgres --password=postgres --no-ssl  -o ./init_db
